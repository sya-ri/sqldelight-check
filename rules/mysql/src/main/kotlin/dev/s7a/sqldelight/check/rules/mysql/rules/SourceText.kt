...
internal fun RuleContext.isMySql(): Boolean = DialectCapabilities.MySql in database.dialect.capabilities
    ...
    while (index < chars.size) {
        index =
            when {
                ...
                chars[index] == '#' -> maskLineComment(chars, index)
        ...
        while (index < length) {
            index =
                when {
                    ...
                    this@sqlTokens[index] == '#' -> skipLineComment(index)
