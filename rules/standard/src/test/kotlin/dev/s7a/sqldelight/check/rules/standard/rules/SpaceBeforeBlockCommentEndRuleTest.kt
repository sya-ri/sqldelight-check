...
class SpaceBeforeBlockCommentEndRuleTest {
    @Test
    fun `reports safe fix before block comment end`() {
        val diagnostics =
            SpaceBeforeBlockCommentEndRule().diagnostics(
                """
                /* Player table.*/
                CREATE TABLE player (
    ...
    @Test
    fun `accepts spaced and empty block comments`() {
        SpaceBeforeBlockCommentEndRule().assertDiagnosticCount(
            """
            /* Player table. */
            /**/
            CREATE TABLE player (
