    ...
    fun `standard rule set provides built in style rules`() {
        ...
        assertEquals(
            setOf(
                ...
                qualifiedRuleId("standard:no-drop-column-in-migration"),
                ...
                qualifiedRuleId("standard:no-rename-column-in-migration"),
                qualifiedRuleId("standard:no-rename-table-in-migration"),
                ...
                qualifiedRuleId("standard:no-update-all"),
