...
TODO: Add a checked-in screenshot or a published sample report link after the first public report artifact is produced.
Do not generate a placeholder image; use a real report generated by the plugin so the README reflects the actual UI.
